...
{% set stage_additional_info = "url='s3://frostyfridaychallenges/challenge_8/' file_format=(type=csv SKIP_HEADER =1)" %} -- noqa: L016

{%- if execute and var('ch08', var('run_all', false)) %}
{{ create_stage(
